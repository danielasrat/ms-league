...
//       const res = await axios.get(`http://localhost:3000/tv-shows/${id}`, {
...
//     try {
//       const token = localStorage.getItem('token');
//       await axios.put(`http://localhost:3000/tv-shows/${id}`, form, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
//       navigate('/tv-shows');
//     } catch (error) {
...
//       <h1 className="text-2xl font-bold mb-4">Edit TV Show</h1>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow">
            <h1 className="text-2xl font-bold mb-6">Edit TV Program</h1>
            <form onSubmit={handleSubmit} className="space-y-4">
