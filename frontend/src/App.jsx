  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/tv-shows/create" element={
          <ProtectedRoute>
            <CreateTvShow />
          </ProtectedRoute>
        } />
        
        <Route path="/tv-shows/edit/:id" element={
          <ProtectedRoute>
            <EditTvShow />
          </ProtectedRoute>
        } />
        ...
        <Route path="/user-events2" element={
          <ProtectedUserRoute>
            <UserEventsPage2 />
          </ProtectedUserRoute>
        } />
        ...
        <Route path="/manage-event-registration" element={
          <ProtectedRoute>
    ...
    <Route path="/user-tv-shows" element={
      <ProtectedUserRoute>
        <UserTvShowsPage />
      </ProtectedUserRoute>
    } />

    <Route path="/user-tv-shows2" element={
      <ProtectedUserRoute>
        <UserTvShowsPage2 />
      </ProtectedUserRoute>
    } />
